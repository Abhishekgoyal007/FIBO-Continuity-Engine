...
const SHOT_TEMPLATES: Record<string, Omit<Shot, 'id' | 'status'>[]> = {
  'character-turnaround': [
    ...
    { name: 'Back View', cameraAngle: 180, cameraHeight: 0, fov: 50, framing: 'full', instructions: 'BACK OF CHARACTER ONLY, do not show face, subject facing away, SAME CLOTHING fully closed on back, no exposed skin, identical outfit from behind' },
  ],
  'product-360': [
    ...
    { name: '180°', cameraAngle: 180, cameraHeight: 0, fov: 50, framing: 'medium', instructions: 'BACK VIEW ONLY, 180 degrees, rear of subject, same clothing fully closed, no exposed skin' },
